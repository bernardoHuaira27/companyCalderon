...
/**
 * Class neom_Customize_Slider_Control
 */
class neom_Customize_Slider_Control extends neom_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="neom-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="neom-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'neom-blog' ); ?></span></span>
			</div>
		</div>

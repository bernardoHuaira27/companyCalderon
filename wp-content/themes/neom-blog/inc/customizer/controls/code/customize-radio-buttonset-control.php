...
/**
 * Class neom_Customize_Radio_Buttonset_Control
 */
class neom_Customize_Radio_Buttonset_Control extends neom_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'neom-radio-buttonset';
